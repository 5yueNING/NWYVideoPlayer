...
public class SPUtils {
    ...
    private SPUtils(final String spName) {
        sp = NWYVideoPlayer.getInstance().getApplication().getSharedPreferences(spName, Context.MODE_PRIVATE);
    }

    private SPUtils(final String spName, final int mode) {
        sp = NWYVideoPlayer.getInstance().getApplication().getSharedPreferences(spName, mode);
    }
    ...
    public static SPUtils getInstance(String spName, final int mode) {
        if (isSpace(spName)) {
            spName = Constant.DEFAUT_SHAREDPREFERENCES_NAME;
        }
