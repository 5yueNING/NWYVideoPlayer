...
public class OkGoUtils {
    ...
    private static void initOkGo(Application application) {
        ...
        //4. 配置超时时间
        builder.readTimeout(Constant.HTTP_TIMEOUT_DEFALUT, TimeUnit.MILLISECONDS);
        builder.writeTimeout(Constant.HTTP_TIMEOUT_DEFALUT, TimeUnit.MILLISECONDS);
        builder.connectTimeout(Constant.HTTP_TIMEOUT_DEFALUT, TimeUnit.MILLISECONDS);
