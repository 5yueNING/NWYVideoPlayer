package com.ningwuyue.sdk.videoplayer.util;
...
public class LogUtils {
    ...
    public static void init(boolean logSwitch, boolean log2FileSwitch, char logFilter, String tag) {
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
            dir = NWYVideoPlayer.getInstance().getApplication().getExternalCacheDir().getPath() + File.separator;
        } else {
            dir = NWYVideoPlayer.getInstance().getApplication().getCacheDir().getPath() + File.separator;
        }
    ...
    public static Builder getBuilder() {
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
            dir = NWYVideoPlayer.getInstance().getApplication().getExternalCacheDir().getPath() + File.separator + "log" + File.separator;
        } else {
            dir = NWYVideoPlayer.getInstance().getApplication().getCacheDir().getPath() + File.separator + "log" + File.separator;
        }
        return new Builder();
    }
