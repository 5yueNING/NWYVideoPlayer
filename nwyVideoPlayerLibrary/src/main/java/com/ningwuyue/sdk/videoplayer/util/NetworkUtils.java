...
public class NetworkUtils {
    ...
    public static void openWirelessSettings() {
        NWYVideoPlayer.getInstance().getApplication().startActivity(
    ...
    public static boolean getMobileDataEnabled() {
        try {
            TelephonyManager tm =
                    (TelephonyManager) NWYVideoPlayer.getInstance().getApplication().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) NWYVideoPlayer.getInstance().getApplication().getSystemService(Context.WIFI_SERVICE);
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm =
                (ConnectivityManager) NWYVideoPlayer.getInstance().getApplication().getSystemService(Context.CONNECTIVITY_SERVICE);
        return cm != null
